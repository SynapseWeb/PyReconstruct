...
from .ops import (
    Initialization, FileOperations,                                    # core funcs
...
class MainWindow(
        QMainWindow, Initialization, FileOperations,                                 
        MenuOperations, UIOperations, ViewOperations,                   
        ImageOperations, NavigationOperations, ImportExportOperations,  
        HistoryOperations, ThreeDimensionalOperations, ProjectOperations
):
