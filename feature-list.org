...
- [ ] Next Vijay meeting: Monday, August 8, ~1030
...
* Lab meeting
** Intro
** Start new series from scratch (? vol Joseph)
** Demo tools
** Open existing series
** Go back to old Reconstruct after making changes
** Vijay integration
*** To Neuroglancer
- [ ] Export to zarr (? Vijay has code for this)
*** Autosegmnet (Vijay)
*** Back to Reconstruct
- [ ] How translate .zarr to field coordinates?
- [ ] ZarrGrid class?
