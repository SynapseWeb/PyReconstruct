...
- [ ] Trace list
   - [ ] Make trace list index column not obligatory (default to off)
   - [ ] Fix header for index columns
...
- [ ] Mouse wheel and copy/past function doesn't change until next event

- [ ] Add header to history for easy copy/paste exporting
