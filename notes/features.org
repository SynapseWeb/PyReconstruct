...
- Keep stamps for p06, p07, p08
- Keep d03 shaft (purple dendrite)
- Zoom on Wednesday the Jan 4th (1-3 PM?)
...
- [ ] Updated "truncating transform" warning to also indicate section number
...
- [ ] Brightness / Contrast
   ...
   - [ ] Make bright / con changes less dramatic (finer control)
