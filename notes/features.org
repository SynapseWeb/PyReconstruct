...
- [-] Object list
   ...
   - [ ] Standard regexp tick boxes to filter (e.g., synapses = *[_ ]c[_][0-9]+)
...
- [ ] Select tool - only select object that are entirely surrounded by selection
...
- [-] Mouse palette
   ...
   - [ ] Fix pallet shortcuts on open series
   - [ ] Fix stamp size and make default 0.1
...
- [-] Move traces in field
   - [X] Double click left and hold to move
